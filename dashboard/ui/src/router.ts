...
const routes = [
  ...
  { path: '/app/more/paper', component: () => import('./views/PaperRiskView.vue'), meta: { title: '模拟盘风控' } },
  { path: '/app/more/agents', component: () => import('./views/AgentOpsView.vue'), meta: { title: 'Agent 操作' } },
  { path: '/app/more/conditional-orders', component: () => import('./views/ConditionalOrdersView.vue'), meta: { title: '条件单' } },
